...
You can use Elkar self-hosted version as a simple library with implemented task management and streaming in local memory. Support for other task stores as PostgreSQL or Redis will come soon. Checkout our [**GitHub repository**](https://github.com/elkar-ai/elkar-a2a)
