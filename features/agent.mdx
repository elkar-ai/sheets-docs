...
<Steps>
  <Step title="Goal Understanding">
    You describe what you want to achieve: _"Build a quarterly budget model"_ or _"Analyze sales performance trends"_
  </Step>
  ...
  <Step title="Adaptive Learning">
    Agent learns from your feedback and preferences to improve future planning and execution
  </Step>
</Steps>
...
<Tabs>
  <Tab title="Strategic Analysis">
    ...
    **Example:** _"Plan our market expansion strategy considering budget constraints, competitive landscape, and growth targets"_
  </Tab>
  <Tab title="Financial Planning">
    ...
    **Example:** _"Plan optimal budget allocation across marketing, sales, and product development to maximize growth"_
  </Tab>
  <Tab title="Operational Planning">
    ...
    **Example:** _"Plan our Q4 launch considering resource constraints, market timing, and competitive factors"_
  </Tab>
</Tabs>
