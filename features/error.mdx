...
<Card title="Formula Tracing" icon="calculator">
  Need to debug complex calculations? Use [Formula Tracing](/features/tracing) to step through your formulas and identify issues.
</Card>